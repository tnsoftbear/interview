...
/**
 * TODO: - find another solution for testing-task 1 -
 * If you've solved the first task with help of mathematic, please try to avoid this kind of calcluations in next solution.
 * Other words don't use %, / operations.
 * 
